package es.reinosdeleyenda.flamethrower_lib.service.plugin;
...
import es.reinosdeleyenda.flamethrower_lib.service.SettingsChangedListener;
...
import es.reinosdeleyenda.flamethrower_lib.service.plugin.function.NoteFunction;
...
import es.reinosdeleyenda.flamethrower_lib.service.plugin.settings.PluginSettings;
...
\endluacode
\param line \b es.reinosdeleyenda.flamethrower_lib.window.TextTree$Line the line to append, this usually comes from a trigger callback
\returns none
\par Example 
\luacode
...
Gets the raw /c es.reinosdeleyenda.flamethrower_lib.service.WindowToken object that is being held by the background service. This is to allow direct manipulation of the buffer.
...
Gets the raw \b es.reinosdeleyenda.flamethrower_lib.service.settings.SettingsGroup settings, this is to allow direct manipulation.
...
\endluacode
\param none
\returns a \b es.reinosdeleyenda.flamethrower_lib.service.settings.SettingsGroup object that can be directly manipulated.
\par Example 
\luacode
