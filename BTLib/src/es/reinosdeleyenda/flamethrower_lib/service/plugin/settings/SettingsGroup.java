...
public class SettingsGroup extends Option implements Parcelable {
	...
	public SettingsGroup(Parcel p) {
		...
		for(int i=0;i<size;i++) {
			...
			switch(type) {
			case OPTION_BOOLEAN:
				o = p.readParcelable(BooleanOption.class.getClassLoader());
				break;
			case OPTION_LIST:
				o = p.readParcelable(ListOption.class.getClassLoader());
				
				break;
			case OPTION_OPTIONS:
				o = p.readParcelable(SettingsGroup.class.getClassLoader());
				
				break;
			case OPTION_ENCODING:
				o = p.readParcelable(EncodingOption.class.getClassLoader());
				break;
			case OPTION_INTEGER:
				o = p.readParcelable(IntegerOption.class.getClassLoader());
				break;
			case OPTION_COLOR:
				o = p.readParcelable(ColorOption.class.getClassLoader());
				break;
			case OPTION_FILE:
				o = p.readParcelable(FileOption.class.getClassLoader());
				break;
			case OPTION_STRING:
				o = p.readParcelable(StringOption.class.getClassLoader());
				break;
			case OPTION_CALLBACK:
				o = p.readParcelable(CallbackOption.class.getClassLoader());
				break;
			}

			//Option o = p.readParcelable(com.happygoatstudios.flamethrower_lib.service.plugin.settings.Option.class.getClassLoader());
			addOption(o);
		}
	}
