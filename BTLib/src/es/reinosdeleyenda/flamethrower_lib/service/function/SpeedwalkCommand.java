...
public class SpeedwalkCommand extends SpecialCommand {
	...
	private Connection.Data mData = null;
	
	public SpeedwalkCommand(HashMap<String,DirectionData> directions, Connection.Data data) {
	...
	public Object execute(Object o,Connection c) {
		...
		//mData = new es.reinosdeleyenda.flamethrower_lib.service.Connection.Data();
