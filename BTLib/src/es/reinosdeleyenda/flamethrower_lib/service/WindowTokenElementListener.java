...
public class WindowTokenElementListener implements ElementListener {
	...
	private PluginParser.NewItemCallback mCallback = null;
	 ...
	 */
	public WindowTokenElementListener(final PluginParser.NewItemCallback callback, final WindowToken currentWindow) {
