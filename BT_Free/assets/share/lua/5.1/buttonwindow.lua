...
R_id = luajava.bindClass("es.reinosdeleyenda.flamethrower_lib.R$id")
R_layout = luajava.bindClass("es.reinosdeleyenda.flamethrower_lib.R$layout")
R_drawable = luajava.bindClass("es.reinosdeleyenda.flamethrower_lib.R$drawable")
...
Validator = luajava.newInstance("es.reinosdeleyenda.flamethrower_lib.validator.Validator")
