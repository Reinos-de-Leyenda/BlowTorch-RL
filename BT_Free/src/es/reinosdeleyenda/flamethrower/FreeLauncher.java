package es.reinosdeleyenda.flamethrower;
...
import es.reinosdeleyenda.flamethrower_lib.launcher.Launcher;
...
public class FreeLauncher extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        launch.putExtra("LAUNCH_MODE","es.reinosdeleyenda.flamethrower");
        copySharedLibraries();
